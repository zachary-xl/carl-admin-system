<template>
  <div class="salesman-detail-container">
    ...
    <div class="info-section mt-4 mx-4 bg-white rounded-md">
      ...
      <!-- 未投保栏舍 -->
      <div v-for="(pen, index) in penList" :key="`uninsured-${index}`" class="pen-item p-4 border-b border-gray-100">
        ...
        <div class="flex mt-3">
          <div class="pen-image w-24 h-24 mr-4">
            <el-image @click="handlePreview(pen.satelliteMapUrl)" :src="pen.satelliteMapUrl" fit="cover" class="w-full h-full rounded-md"></el-image>
          </div>
